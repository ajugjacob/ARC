...
<body>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <img  src="img/alumni final.png" height="300 px">
     ...
     <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
       <div class="carousel-inner">
        <div class="carousel-item active">
          <img class= "d-block w-70 mx-auto .hidden-xs" id="img1" src="img/gallery/gal1.jpeg" alt="First slide">
    </div>
    <div class="carousel-item">
          <img class= "d-block w-70 mx-auto .hidden-xs" id="img2" src="img/gallery/gal2.jpg"
        alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-70 mx-auto .hidden-xs"  id="img3" src="img/gallery/gal3.jpg"
        alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-70 mx-auto .hidden-xs"  id="img4" src="img/gallery/gal4.jpg"
        alt="Fourth slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-70 mx-auto .hidden-xs"  id="img5" src="img/gallery/gal5.jpg"
        alt="Fifth slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-70 mx-auto .hidden-xs"  id="img6" src="img/gallery/gal6.jpg"
        alt="Sixth slide">
    </div>
  </div>
...
<!-- 
 ...
 -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Madhusoodhanan Nair R.jpeg" alt="Madhusoodhanan Nair R" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Alen George.jpg" alt="Alen George" class="img-fluid">
              <div class="details">
                <h3>Alen George</h3>
                <p>Fourth Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Gayathry Krishnan.jpg" alt="Gayathry Krishnan" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Saketh T Vinod.jpeg" alt="Saketh T Vinod" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Anjali N Nair.jpg" alt="Anjali N Nair" class="img-fluid">
              <div class="details">
                <h3>Anjali N Nair</h3>
                <p>Fourth Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Goutham N Suresh.jpg" alt="Goutham N Suresh" class="img-fluid">
              <div class="details">
            ...
            <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Mekhana Maria Roy.jpg" alt="Mekhana Maria Roy" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Sadiv N S.jpg" alt="Sadiv N S" class="img-fluid">
              <div class="details">
                <h3>Sadiv N S</h3>
                <p>Fourth Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Alex Paul.jpg" alt="Alex Paul" class="img-fluid">
              <div class="details">
                <h3>Alex Paul</h3>
                <p>Third Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Amal Xavier.jpg" alt="Amal Xavier" class="img-fluid">
              <div class="details">
                <h3>Amal Xavier</h3>
                <p>Third Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Archana Rose Biju.jpeg" alt="Archana Rose Biju" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Moniya Mohan.jpg" alt="Moniya Mohan" class="img-fluid">
              <div class="details">
                <h3>Moniya Mohan</h3>
                <p>Third Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Priyadharshini T.jpg" alt="Priyadharshini T" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Ruben Mathew.jpg" alt="Ruben Mathew" class="img-fluid">
              <div class="details">
                <h3>Ruben Mathew</h3>
                <p>Third Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Sandeep Kumar Suresh.jpg" alt="Sandeep Kumar Suresh" class="img-fluid">
              <div class="details">
                <h3>Sandeep Kumar Suresh</h3>
                <p>Third Year</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Sreelekshmi R.jpg" alt="Sreelekshmi R" class="img-fluid">
              <div class="details">
                <h3>Sreelekshmi R</h3>
                <p>Third Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Boney Kuriakose.jpg" alt="Boney Kuriakose" class="img-fluid">
              <div class="details">
                <h3>Boney Kuriakose</h3>
                <p>Second Year</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Romal Austine.jpg" alt="Romal Austine" class="img-fluid">
              <div class="details">
                <h3>Romal Austine</h3>
                <p>Second Year</p>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Nanda Krishnan.jpg" alt="Nanda Krishnan" class="img-fluid">
              <div class="details">
                <h3>Nanda Krishnan</h3>
                <p>Second Year</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mx-auto">
            <div class="speaker">
              <img src="img/team/Brijo T Prince.jpg" alt="Brijo T Princer" class="img-fluid">
              <div class="details">
                <h3>Brijo T Prince</h3>
                <p>Second Year</p>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="fa fa-angle-right"></i> <a href="#activities">Activities</a></li>
             <!--  <li><i class="fa fa-angle-right"></i> <a href="#schedule">Alumini Meet</a></li> -->
              <li><i class="fa fa-angle-right"></i> <a href="#contributions">Contribution</a></li>
              <li><i class="fa fa-angle-right"></i> <a href="#speakers">Team</a></li>
    ...
    <div class="container">
      <div class="copyright">
        <p>MADE WITH <strong style="color: red;">&hearts;</strong> BY DEVCOM</p>
      </div>
    </div>
  </footer><!-- #footer -->
